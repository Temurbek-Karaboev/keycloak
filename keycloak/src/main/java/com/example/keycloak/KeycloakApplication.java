...
import com.example.keycloak.controller.KeycloakAuthClient;
import com.example.keycloak.model.KeycloakAuthResponse;
...
public class KeycloakApplication implements CommandLineRunner {
    ...
    private static final Logger log = LoggerFactory
            .getLogger(KeycloakApplication.class);

    public KeycloakApplication(KeycloakAuthClient keycloakAuthClient, RestTemplate restTemplate) {
